...
class Article
{
    ...
    private function setSummary()
    {
       // $this->summary = substr($this->getContent(), 0, strlen($this->getContent())/2) . "...";
        ...
        $stringTitle = $this->getContent();
        $stringLen = strlen($this->getContent());

        if($stringLen >= 100)
        {
            $finalContent = substr($stringTitle,0,100). "...";
        }
        else
        {
         $finalContent = substr($this->getContent(),0,strlen(($this->getContent())/2)). "...";
        }

        $this->summary = $finalContent;
    }
